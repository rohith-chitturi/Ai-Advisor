...
function f(e) {
	...
	try {
		...
		return t.split(/\r?\n/).flatMap((e) => e.split(/(?<=})\s*(?=\{)/)).map((e) => e.trim()).filter((e) => e.length > 0).map((e) => JSON.parse(e));
	}
}
//#endregion
...
function g(e, t) {
	...
	if (n != null) {
		...
		return () => {
			if (n.aborted) return;
			let i = setTimeout(() => r.abort(h), t), a = () => {
...
var _ = class {
	...
	#a({ path: e, method: t, params: n, contentType: r, body: i, extraRequestInit: a }) {
		...
		return n !== void 0 && p(o.searchParams, n), {
			url: o,
			init: {
				method: t,
	...
	async #o(e) {
		let { url: t, init: n } = this.#a(e), r = (this.#r === void 0 ? null : g(n, this.#r))?.(), s, c;
		try {
			if (this.#n !== void 0) return await this.#n(t, n);
			s = await fetch(t, n), c = await s.text();
		} catch (e) {
			throw new a(t.toString(), Object.is(e, h) ? new o(this.#r, n) : e);
		} finally {
			r?.();
		}
	...
	async #s(e) {
		let { url: t, init: n } = this.#a(e), s = (this.#r === void 0 ? null : g(n, this.#r))?.(), c;
		try {
			if (this.#n !== void 0) {
...
var b = (e) => typeof e == "number" ? e : e.taskUid, x = class {
	#e;
	#t;
	#n;
	#r;
	...
	async waitForTask(e, t) {
		let n = b(e), r = t?.timeout ?? this.#t, i = t?.interval ?? this.#n, a = r > 0 ? new AbortController() : null, o = a === null ? void 0 : setTimeout(() => {
			a.abort(v);
		}, r);
		try {
			for (;;) {
			...
			throw Object.is(e.cause, v) ? new s(n, r) : e;
		}
	}
...
var C = class {
	...
	#e;
	constructor(e, t, n) {
		this.uid = t, this.primaryKey = n, this.httpRequest = new _(e), this.tasks = new x(this.httpRequest, e.defaultWaitOptions), this.#e = S(this.httpRequest, this.tasks);
	}
	async search(e, t, n) {
	...
	async getIndexes(e) {
		let t = await this.getRawIndexes(e), n = t.results.map((e) => new C(this.config, e.uid, e.primaryKey));
		return {
			...t,
			results: n
		};
...
//#endregion
export { t as ContentTypeEnum, n as ErrorStatusCode, C as Index, e as MatchingStrategies, E as Meilisearch, i as MeilisearchApiError, r as MeilisearchError, a as MeilisearchRequestError, o as MeilisearchRequestTimeOutError, s as MeilisearchTaskTimeOutError };
