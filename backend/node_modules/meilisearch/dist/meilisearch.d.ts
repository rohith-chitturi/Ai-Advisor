...
import type { KeyCreation, Config, IndexOptions, IndexObject, Key, Health, Stats, Version, KeyUpdate, IndexesQuery, IndexesResults, KeysQuery, KeysResults, IndexSwap, MultiSearchParams, FederatedMultiSearchParams, MultiSearchResponseOrSearchResponse, EnqueuedTaskPromise, ExtraRequestInit, Network, RecordAny, RuntimeTogglableFeatures, ResourceResults, SearchRule, SearchRuleUpdatePayload, SearchRuleListPayload, Webhook, ResultsWrapper, WebhookCreatePayload, WebhookUpdatePayload, InitializeNetworkOptions, AddRemoteOptions, RemoveRemoteOptions, RenderTemplateParams, RenderTemplateResponse } from "./types/index.js";
...
export declare class Meilisearch {
     ...
     */
    renderTemplate(params: RenderTemplateParams): Promise<RenderTemplateResponse>;
