import type { WaitOptions, TasksOrBatchesQuery, TasksResults, Task, DeleteOrCancelTasksQuery, EnqueuedTaskPromise, TaskUidOrEnqueuedTask, ExtraRequestInit, RecordAny } from "./types/index.js";
...
export declare class TaskClient {
    ...
    getTaskDocuments<D extends RecordAny = RecordAny>(uid: number, extraRequestInit?: ExtraRequestInit): Promise<D[]>;
    /**
